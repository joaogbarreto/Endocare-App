...
class TelaCadastroPT1 extends StatefulWidget {
  const TelaCadastroPT1({Key? key}) : super(key: key);

  @override
  State<TelaCadastroPT1> createState() => _TelaCadastroPT1State();
}

class _TelaCadastroPT1State extends State<TelaCadastroPT1> {
