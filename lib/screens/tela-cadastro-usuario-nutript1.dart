...
class TelaCadastroUsuarioNutricionistaPT1 extends StatefulWidget {
  const TelaCadastroUsuarioNutricionistaPT1({Key? key}) : super(key: key);

  @override
  State<TelaCadastroUsuarioNutricionistaPT1> createState() => _TelaCadastroUsuarioNutricionistaPT1State();
}

class _TelaCadastroUsuarioNutricionistaPT1State extends State<TelaCadastroUsuarioNutricionistaPT1> {
  ...
  botaoEnviarClicado() {
    ...
    if (_formKey.currentState!.validate()) {
      Navigator.pushNamed(context, '/TelaCadastroUsuarioNutricionistaPT2');
    }
  }
